...
const services = [
  ...
  },
  {
    ...
    description: "Coiffures harmonieuses pour accompagner la mariée avec élégance.",
    price: "À partir de 80€",
    features: ["Coordination avec mariée", "Style personnalisé", "Finitions durables"],
  },
  {
    icon: Star,
    title: "Occasions Spéciales",
    description: "Galas, soirées, anniversaires... Brillez lors de vos événements.",
